    ...
    <div className="wp-controls">
      ...
      <div className="wp-controls-row">
        ...
        <div className="wp-controls-right">
          ...
          {onFullscreen && (
            <button className={`wp-ctrl-btn wp-fullscreen-btn${isFullscreen ? ' active' : ''}`} onClick={onFullscreen} title={isFullscreen ? 'Exit Fullscreen' : 'Fullscreen'}>
              {isFullscreen ? (
                <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
          ...
          {onTuneOut && (
            <button className="wp-ctrl-btn wp-tune-out-btn" onClick={onTuneOut} title="Tune Out">
              <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
