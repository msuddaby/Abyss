...
namespace Abyss.Api.Migrations
{
    ...
    [Migration("20260617152502_AddShoutboxSupport")]
    partial class AddShoutboxSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Abyss.Api.Models.Channel", b =>
                {
                    ...
                    b.Property<int?>("RssRefreshIntervalMinutes")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("XenForoNodeId")
                        .HasColumnType("integer");

                    b.Property<string>("XenForoNodeTitle")
                        .HasMaxLength(120)
            ...
            modelBuilder.Entity("Abyss.Api.Models.Message", b =>
                {
                    ...
                    b.Property<string>("GhostAuthorAvatarUrl")
                        .HasMaxLength(2048)
                        .HasColumnType("character varying(2048)");

                    b.Property<string>("GhostAuthorName")
                        .HasMaxLength(64)
                    ...
                    b.Property<int?>("XfPostId")
                        .HasColumnType("integer");

                    b.Property<string>("XfPostUrl")
                        .HasMaxLength(2048)
                        .HasColumnType("character varying(2048)");
            ...
            modelBuilder.Entity("Abyss.Api.Models.XenForoConnection", b =>
                {
                    b.Property<string>("OwnerId")
                        .HasColumnType("text");
                    ...
                    b.Property<int>("XfUserId")
                        .HasColumnType("integer");

                    b.Property<string>("XfUsername")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("XenForoConnections");
                });

            modelBuilder.Entity("Abyss.Api.Models.XenForoPostMessage", b =>
                {
                    b.Property<int>("XfPostId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ChannelId", "XfPostId");

                    b.ToTable("XenForoPostMessages");
                });
