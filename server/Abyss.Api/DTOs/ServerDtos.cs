...
public record InviteDto(Guid Id, string Code, Guid? ServerId, string? CreatorId, DateTime CreatedAt, DateTime? ExpiresAt, int? MaxUses, int Uses, DateTime? LastUsedAt, bool AllowGuests = false);
